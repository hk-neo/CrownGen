...
import numpy as np
import trimesh
from mesh_recon.src.data.core import Field
...
class PointCloudField(Field):
    ...
    def load_tooth(self, model_path):
        pointcloud_dict =  np.load(os.path.join(model_path, 'pointcloud.npz'))
